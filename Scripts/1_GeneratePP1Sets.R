...
# ==========================================================
# ==========================================================
# DensePPI_v2.8 — All-hubs (FirstProtein→LastProtein) STRING subnetwork set generation (robust hub sampling)
# ==========================================================
...
# ==========================================================
in_file <- "~/Desktop/NIRRA/FINAL/DataFinalv2/Zscored_Collapsed_Proteins.csv"
out_dir <- "~/Desktop/NIRRA/FINAL/DataFinalv2/031826/"
...
prot_start <- which(names(df) == "A1BG")
prot_end   <- which(names(df) == "TMED7")
